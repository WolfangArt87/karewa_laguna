...
organizationSchema = mongoose.Schema({
    ...
    title: {
        type: String,
        required: true,
        default: "Monitor Karewa Laguna"
    },
    description: {
        type: String,
        default: "Aquí podras obtener información sobre los procedimientos de contrataciones públicas, incluyendo la compra, renta y contratación de servicios que se realizan en los Municipios de Torreón, Gómez Palacio, Lerdo y Matamoros."
    },
    contactLocation: {
        type: String,
        default: ""
