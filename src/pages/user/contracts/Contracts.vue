            ...
            <div class="neutral-width">
                ...
                <div class="col-12 p-0">
                    <div class="card o-visible">
                        ...
                        <p class="f-14 c-plain_text principal-font-regular">Aquí podrás encontrar la lista de todos los contratos que han sido firmados por los municipios de Torreón, Gómez Palacio, Lerdo y Matamoros.<br/>
