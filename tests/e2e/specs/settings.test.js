...
module.exports = {
    ...
    'Settings': function (browser) {
        ...
        browser
            ...
            .assert.visible(utils.xpath.elementWithPlaceholder("textarea", "Aquí podrás obtener información sobre los procedimientos de licitaciones para comparar la compra, renta y contratación de serviciosque se realizan en el Monitor Karewa Laguna."))
            .clearValue(utils.xpath.elementWithPlaceholder("textarea","Aquí podrás obtener información sobre los procedimientos de licitaciones para comparar la compra, renta y contratación de serviciosque se realizan en el Monitor Karewa Laguna."))
            .setValue(utils.xpath.elementWithPlaceholder("textarea","Aquí podrás obtener información sobre los procedimientos de licitaciones para comparar la compra, renta y contratación de serviciosque se realizan en el Monitor Karewa Laguna."), "Aquí podras obtener información sobre los procedimientos de contrataciones públicas, incluyendo la compra, renta y contratación de servicios que se realizan en los Municipios de Torreón, Gómez Palacio, Lerdo y Matamoros.")
